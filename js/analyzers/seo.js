const SEOAnalyzer = {
    analyze(doc) {
        ...
        const ogDesc     = g('meta[property="og:description"]', 'content');
        const ogImage    = g('meta[property="og:image"]', 'content');
        const twitterCard= g('meta[name="twitter:card"]', 'content');
        ...
        return {
            ...
            title, metaDesc, metaKw, canonical,
            ogTitle, ogDesc, ogImage, twitterCard, viewport, robots,
            h1s, h2s, h3s,
