const ContentAnalyzer = {
  analyze(doc) {
    ...
    const keywords = Object.entries(freq).sort((a,b)=>b[1]-a[1]).slice(0,16).map(([w])=>w);
    ...
    return { headings: headings.slice(0,10), paragraphCount: paras.length, keywords, topics, tags, wordCount: words.length };
  }
};
